...
from intf.blog.models import Post, Comment, Tag
import re
...
def index(request):
	...
	if posttitle and postcontent:
		Post.objects.create(title=posttitle, content=postcontent).save()
	...
	if searchterm:
        ...
        return render_to_response('blogdetail.html', {'searchtitle': searchtitle, 'searchtext': searchtext, 'tags': tags, 'archive': archive})
	else:
		return render_to_response('blogdetail.html', {'index': index, 'data': data, 'nextpage': nextpage, 'tags': tags, 'archive': archive})
...
def archive(request,month):
    ...
    if searchterm:
        ...
        return render_to_response('blogdetail.html', {'data': data, 'tags': tags, 'archive': archive})
...
def page(request,pagecount):
    ...
    if searchterm:
        ...
        return render_to_response('blogdetail.html', {'data': data, 'nextpage': nextpage, 'tags': tags, 'archive': archive})
...
def posting(request,title):
    ...
    if searchterm:   
        ...
        return render_to_response('blogdetail.html', {'data': data, 'post': post, 'comments': comments, 'tags': tags, 'archive': archive})
